  ...
  renderProductInfo() {
    ...
    fetch(
      ...
      .then((responseText) => {
        ...
        //change coupon div
        let couponSource = html.getElementById("coupon");
        let couponDestination = document.getElementById("coupon");
        if (couponSource && couponDestination) {
          couponSource.innerHTML = couponDestination.innerHTML;
        }
        ...
        const addButtonPrev = document.getElementById(
          `ProductSubmitButton-${
            this.dataset.originalSection
              ? this.dataset.originalSection
              : this.dataset.section
        ...
        if (addButtonPrev && addButtonUpdated) {
          addButtonPrev.textContent = addButtonUpdated.textContent;
        }
...
// Custom Component for Variant Offer
